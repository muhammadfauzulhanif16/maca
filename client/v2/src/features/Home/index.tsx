    ...
    <Layout titlePage="Dashboard">
      <div className="mb-6 flex justify-between">
        ...
        <button
          ...
          className="shadow-sm py-2 bg-cyan-700 hover:bg-cyan-800 font-medium px-4 rounded-lg text-cyan-50 flex items-center"
        >
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-8">
          {Page.map(({ icon, title }) => (
            <div className="font-medium bg-cyan-50 shadow-sm rounded-lg">
