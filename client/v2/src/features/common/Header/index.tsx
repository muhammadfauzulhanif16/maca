  ...
  return (
    <header>
      <div className="py-4 border-b-2 flex justify-between">
        <label
          className="transition-all ease-in-out hover:shadow-sm group flex items-center cursor-pointer rounded-xl hover:bg-zinc-100 dark:hover:bg-zinc-800 px-4 py-2"
          htmlFor="search"
        >
          ...
          <input
            id="search"
            name="search"
            className="transition-all ease-in-out group-hover:bg-zinc-100 dark:group-hover:bg-zinc-800 ml-4 bg-zinc-50 dark:bg-zinc-900 outline-0"
            type="text"
            placeholder="Search"
          />
        </label>
