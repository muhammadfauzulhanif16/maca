  ...
  return (
    <>
      {link ? (
        <Link
          to={link.toLowerCase()}
          className={`group transition-all duration-500 ease-in-out hover:text-slate-50 dark:hover:text-slate-900 cursor-pointer ${className} flex flex-col items-center hover:shadow-xl hover:shadow-slate-100 dark:hover:shadow-slate-800 rounded-3xl`}
          onClick={onClick}
        >
